...
export async function GET(request: NextRequest) {
    ...
    try {
        const laravelRes = await laravelApi.get('/owners', {
        ...
        const message = error?.response?.data?.message || 'Failed to fetch owners'
...
export async function POST(request: NextRequest) {
    ...
    try {
        ...
        const laravelRes = await laravelApi.post('/owners', body, {
            headers: cookieString ? { cookie: cookieString } : undefined,
        })
