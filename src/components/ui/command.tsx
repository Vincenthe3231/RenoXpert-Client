...
>(({ className, ...props }, ref) => (
  <CommandPrimitive
    ref={ref}
    className={cn(
      'flex h-full w-full flex-col overflow-hidden rounded-md bg-white dark:bg-dark text-foreground',
      className
    )}
    {...props}
  />
...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ref={ref}
      className={cn(
        "fixed left-[50%] top-[50%] z-50 grid w-full max-w-lg translate-x-[-50%] translate-y-[-50%] gap-4 bg-white dark:bg-darkgray shadow-lg duration-200 rounded-lg overflow-hidden p-0",
        // Pop-up animation (zoom + fade only, no slide animations)
...
>(({ className, ...props }, ref) => (
  <div
    className='flex items-center border-b border-border dark:border-gray-600 px-3'
    cmdk-input-wrapper=''>
